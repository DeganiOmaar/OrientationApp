                ...
                child: ListView.builder(
                    ...
                    itemBuilder: ((context, index) {
                      return ExperienceCard(
                          ...
                          category: "Etudiant",
                          branche: _resultList[index]['filiere'],
                          name: _resultList[index]['nom'],
                          location: _resultList[index]['localisation'],
                          niveaudetude: _resultList[index]['niveau'],
                          duree: "  0-1 ans",
                          facultename: _resultList[index]['faculte'],
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => ExperienceDetails(
                                          imgLink: _resultList[index]
                                              ['imgLink'],
                                          nom: _resultList[index]['nom'],
                                          filiere: _resultList[index]
                                              ['filiere'],
