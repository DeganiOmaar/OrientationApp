                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: ((context, index) {
                      return BouseCard(
                          ...
                          bourseName: _resultList[index]['titre'],
                          location: _resultList[index]['localisation'],
                          diplomeName: _resultList[index]['niveau'],
                          time: _resultList[index]['duree'],
                          tempsPartiel: _resultList[index]['travail'],
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => DetailsBourses(
                                    bourseid: _resultList[index]
                                        ['bourse_id'],
                                    role: userData['role'],
                                    link: _resultList[index]['lien'],
                                    title: _resultList[index]['titre'],
                                    localisation: _resultList[index]
                                        ['localisation'],
                                    niveau: _resultList[index]['niveau'],
                                    duree: _resultList[index]['duree'],
                                    travail: _resultList[index]['travail'],
                                    description: _resultList[index]
                                        ['description'],
                                    instutut: _resultList[index]
                                        ['instutut'],
                                    exigences1: _resultList[index]
                                        ['exigences1'],
                                    exigences2: _resultList[index]
                                        ['exigences2'],
                                    exigences3: _resultList[index]
                                        ['exigences3']),
                              ),
                            );
