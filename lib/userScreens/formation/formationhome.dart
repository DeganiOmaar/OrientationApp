                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: ((context, index) {
                        ...
                        return FormationCard(
                            ...
                            formationType: result['titre'],
                            comapgnyName: result['nomDeLaSociete'],
                            formationName: result['contenue'],
                            formationDuration: result['duree'],
                            formationCertified: result['certification'],
                            formationPlace: result['type'],
                            formationPrice: result['prix'],
                            onPressed: () {
                              Get.to(() => FormationDetails(
                                    instructeur: result['instructeur'],
