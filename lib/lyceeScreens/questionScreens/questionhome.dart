...
import 'package:orientation_app/lyceeScreens/questionScreens/addquestion.dart';
import 'package:orientation_app/lyceeScreens/questionScreens/quetion.dart';
...
class AvisHome extends StatefulWidget {
  const AvisHome({super.key});

  @override
  State<AvisHome> createState() => _AvisHomeState();
}

class _AvisHomeState extends State<AvisHome> {
  Map userData = {};
  bool isLoading = true;
        ...
        child: GNav(
          ...
          tabs: const [
            GButton(
              ...
              iconSize: 24,
              text: 'question des Eleves',
            ),
            GButton(
              icon: Icons.add_circle_outline,
              iconSize: 24,
              text: 'Ajouter un question',
            ),
          ],
        ),
      ),
