...
class InformatiqueScreen extends StatefulWidget {
  const InformatiqueScreen({super.key});

  @override
  State<InformatiqueScreen> createState() => _InformatiqueScreenState();
}

class _InformatiqueScreenState extends State<InformatiqueScreen> {
  @override
            ...
            children: [
             ...
             Row(
                children: [
                  ...
                  const Gap(60)
,                  const Text("Pour le 2éme Informatique", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
                ],
              ),
              const SizedBox(height: 15,),
              const Divider(), 
              ...
              const Divider(), 
               const SizedBox(height: 15,),
              const Text("Pour le 3éme Informatique", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
              const SizedBox(height: 15,),
              const Divider(), 
              const SizedBox(height: 10,),
              const Row(
                ...
                children: [
                 Column(
                    ...
                    children: [
                      ...
                      Text("Physique", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                      Text("Algorithme", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                      Text("Systéme", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                      Text("Sport", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
              ...
              const Divider(), 
                  const SizedBox(height: 10,),
              const Text("Pour le Bac Informatique", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
              const SizedBox(height: 15,),
              const Divider(), 
              const SizedBox(height: 10,),
              const Row(
                ...
                children: [
                 Column(
                    ...
                    children: [
                      ...
                      Text("Systéme", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                       Gap(30),
                      Text("Base de données", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                      Text("Sport", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                      Text("Sujet optionnel", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
