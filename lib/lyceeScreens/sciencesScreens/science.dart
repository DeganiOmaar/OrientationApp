...
,                  const Text("Pour le 2éme Sciences", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
              ...
              const Divider(), 
               const SizedBox(height: 15,),
              const Text("Pour le 3éme Sciences", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
              const SizedBox(height: 15,),
              const Divider(), 
              const SizedBox(height: 10,),
              const Row(
              ...
              const Divider(), 
                  const SizedBox(height: 10,),
              const Text("Pour le Bac Sciences", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
              const SizedBox(height: 15,),
              const Divider(), 
              const SizedBox(height: 10,),
              const Row(
