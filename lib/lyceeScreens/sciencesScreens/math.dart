...
,                  const Text("Pour le 2éme Sciences", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
              ...
              const Divider(), 
               const SizedBox(height: 15,),
              const Text("Pour le 3éme Mathématique", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
              const SizedBox(height: 15,),
              const Divider(), 
              const SizedBox(height: 10,),
              const Row(
                ...
                children: [
                 Column(
                    ...
                    children: [
                      ...
                      Text("Geographie", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                      Text("Isalamique", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                 ...
                 Column(
                    ...
                    children: [
                      ...
                      Text("1h/Semaine", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                      Text("7h/Semaine", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                      Text("5h/Semaine", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                      Text("1.5h/Semaine", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
              ...
              const Divider(), 
                  const SizedBox(height: 10,),
              const Text("Pour le Bac Mathématique", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
              const SizedBox(height: 15,),
              const Divider(), 
              const SizedBox(height: 10,),
              const Row(
