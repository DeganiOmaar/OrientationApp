...
class LettresScreen extends StatefulWidget {
  const LettresScreen({super.key});

  @override
  State<LettresScreen> createState() => _LettresScreenState();
}

class _LettresScreenState extends State<LettresScreen> {
  @override
            ...
            children: [
             ...
             Row(
                children: [
                  ...
                  const Gap(60)
,                  const Text("Pour le 2éme Lettres", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
                ],
              ),
              const SizedBox(height: 15,),
              const Divider(), 
                ...
                children: [
                 Column(
                    ...
                    children: [
                      ...
                      Gap(30),
                      Text("Mathematiques", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                      Text("S.V.T", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
              ...
              const Divider(), 
               const SizedBox(height: 15,),
              const Text("Pour le 3éme Lettres", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
              const SizedBox(height: 15,),
              const Divider(), 
              const SizedBox(height: 10,),
              const Row(
              ...
              const Divider(), 
                  const SizedBox(height: 10,),
              const Text("Pour le Bac Lettres", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
              const SizedBox(height: 15,),
              const Divider(), 
              const SizedBox(height: 10,),
              const Row(
                ...
                children: [
                 ...
                 Column(
                    ...
                    children: [
                      ...
                      Text("2h/Semaine", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                      Text("6h/Semaine", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                      Text("1.5h/Semaine", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
                      Gap(30),
                      Text("2h/Semaine", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, ),),
